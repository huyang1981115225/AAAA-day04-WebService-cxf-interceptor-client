 ...
 * 2019-01-14T16:12:07.107+08:00
 * Generated source version: 2.5.9
 * 
 */
@WebServiceClient(name = "HelloWSImplService", 
                  wsdlLocation = "http://localhost:7777/AAAA-day04-WebService-cxf-interceptor/interceptorws?wsdl",
...
public class HelloWSImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:7777/AAAA-day04-WebService-cxf-interceptor/interceptorws?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWSImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:7777/AAAA-day04-WebService-cxf-interceptor/interceptorws?wsdl");
        }
        WSDL_LOCATION = url;
    }
